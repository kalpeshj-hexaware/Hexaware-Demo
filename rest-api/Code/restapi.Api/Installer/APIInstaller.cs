...
using ElmahCore.Mvc;
using ElmahCore;
using restapi.Api.Filters;
using restapi.Business.Installer;

namespace restapi.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "restapi API", Version = version + "-" + branch});
            });
