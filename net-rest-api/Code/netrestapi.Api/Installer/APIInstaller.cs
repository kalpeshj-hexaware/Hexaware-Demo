...
using ElmahCore.Mvc;
using ElmahCore;
using netrestapi.Api.Filters;
using netrestapi.Business.Installer;

namespace netrestapi.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "netrestapi API", Version = version + "-" + branch});
            });
