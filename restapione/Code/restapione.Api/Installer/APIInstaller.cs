...
using ElmahCore.Mvc;
using ElmahCore;
using restapione.Api.Filters;
using restapione.Business.Installer;

namespace restapione.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "restapione API", Version = version + "-" + branch});
            });
